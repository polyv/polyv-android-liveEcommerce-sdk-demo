...
import com.easefun.polyv.livecommon.utils.imageloader.IPLVImageLoadEngine;
import com.easefun.polyv.livecommon.utils.imageloader.PLVAbsProgressListener;
import com.easefun.polyv.livecommon.utils.imageloader.glide.progress.PLVMyProgressManager;
import com.easefun.polyv.livecommon.utils.imageloader.glide.progress.PLVOnProgressListener;
...
public class PLVGlideImageLoadEngine implements IPLVImageLoadEngine {
    ...
    public void loadImage(Context context, final String moduleTag, final Object urlTag, @DrawableRes int errorRes, @NonNull PLVAbsProgressListener listener, final ImageView view) {
        ...
        PolyvCommonLog.i(TAG, "moduleTag：" + moduleTag + "**urlTag：" + urlTag + "**url：" + url);
        PLVMyProgressManager.addListener(moduleTag, urlTag, new PLVOnProgressListener(listener.getUrl()) {
            ...
            public void onProgress(String url, boolean isComplete, int percentage, long bytesRead, long totalBytes) {
                PolyvCommonLog.i(TAG, "onProgress url：" + url + "**" + isComplete + "**" + percentage + "**" + urlTag);
            ...
            public void onStart(String url) {
                PolyvCommonLog.i(TAG, "onStart url：" + url + "**" + urlTag);
...
//                        .transform(new PLVCompressTransformation(context, url))
                ...
                .listener(new RequestListener<Drawable>() {
                    ...
                    public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                        PolyvCommonLog.i(TAG, "onLoadFailed url：" + url + "**" + urlTag + "**" + (e != null ? e.getMessage() : ""));
                    ...
                    public boolean onResourceReady(Drawable resource, Object model, Target<Drawable> target, DataSource dataSource, boolean isFirstResource) {
                        PolyvCommonLog.i(TAG, "onResourceReady1 url：" + url + "**" + urlTag + "**" + view.getWidth() + "**" + view.getHeight());
                        PLVOnProgressListener l = PLVMyProgressManager.getProgressListener(moduleTag, urlTag);
                        if (l != null) {
                ...
                .into(new ViewTarget<ImageView, Drawable>(view) {
                    ...
                    public void onResourceReady(@NonNull Drawable resource, @Nullable Transition<? super Drawable> transition) {
                        PolyvCommonLog.i(TAG, "onResourceReady2 url：" + url + "**" + urlTag + "**" + resource.getIntrinsicWidth() + "**" + resource.getIntrinsicHeight());
                        PLVOnProgressListener l = PLVMyProgressManager.getProgressListener(moduleTag, urlTag);
                        if (l instanceof PLVAbsProgressListener) {
                    ...
                    public void onDestroy() {
                        PolyvCommonLog.i(TAG, "onDestroy url：" + url + "**" + urlTag);
