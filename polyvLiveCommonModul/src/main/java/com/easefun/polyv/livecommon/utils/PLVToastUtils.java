 ...
 * </pre>
 */
public final class PLVToastUtils {
    ...
    public static void setGravity(final int gravity, final int xOffset, final int yOffset) {
        PLVToastUtils.gravity = gravity;
        PLVToastUtils.xOffset = xOffset;
        PLVToastUtils.yOffset = yOffset;
    }
    ...
    public static void setBgColor(@ColorInt final int backgroundColor) {
        PLVToastUtils.bgColor = backgroundColor;
    }
    ...
    public static void setBgResource(@DrawableRes final int bgResource) {
        PLVToastUtils.bgResource = bgResource;
    }
    ...
    public static void setMsgColor(@ColorInt final int msgColor) {
        PLVToastUtils.msgColor = msgColor;
    }
